...
export const LOCAL_STORE_SEARCH = {
  ...
  appliances: {
    // Generic appliance-parts business intent — NOT washing-machine specific
    en:'appliance parts',                   de:'Hausgeräte Ersatzteile',
    fr:'pièces détachées électroménager',   es:'repuestos electrodomésticos',
    it:'ricambi elettrodomestici',          pl:'części AGD serwis',
    sr:'servis kućnih aparata',             hr:'servis kućanskih aparata',
    mk:'сервис за апарати',                 tr:'beyaz eşya yedek parça',
    sv:'reservdelar hushållsmaskiner',      no:'reservedeler hvitevarer',
    da:'reservedele husholdningsapparater', fi:'kodinkoneiden varaosat',
    nl:'onderdelen huishoudapparaten',      pt:'peças electrodomésticos',
    ...
    bg:'резервни части домакински уреди',
  },
  home: {
